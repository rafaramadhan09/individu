...
<div class="container mt-5">
    ...
    <form action="out.php" method="post" class="needs-validation" novalidate>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="nilai" class="form-label">nilai1:</label>
            ...
            <input type="number" class="form-control" id="nilai" name="nilai" min="0" max="100" required>
            <label for="nilai" class="form-label">Nilai_uts:</label>
            <input type="number" class="form-control" id="nilai" name="nilai" min="0" max="100" required>
            <label for="nilai" class="form-label">nilai_uas:</label>
            <input type="number" class="form-control" id="nilai" name="nilai" min="0" max="100" required>
            <label for="nilai" class="form-label">Nilai_absen:</label>
            <input type="number" class="form-control" id="nilai" name="nilai" min="0" max="100" required>
        </div>
